<header class="header">
    <div class="header-block header-block-collapse hidden-lg-up hidden-lg">
        ...
        <ul class="nav-profile">
            ...
            <li class="profile dropdown">
                ...
                <div class="dropdown-menu profile-dropdown-menu" aria-labelledby="dropdownMenu1">
                    ...
                    <a class="dropdown-item" href="https://forecastclash.com/forecast_clash/users/login"> <i class="fa fa-power-off icon"></i> Logout </a>
                </div>
            </li>
        </ul>
    </div>
