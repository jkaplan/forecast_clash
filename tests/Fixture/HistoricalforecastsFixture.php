...
class HistoricalforecastsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'location' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => null, 'comment' => '', 'precision' => null],
        'distance' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'location' => ['type' => 'index', 'columns' => ['location'], 'length' => ['location' => '32']],
        ],
        '_constraints' => [
